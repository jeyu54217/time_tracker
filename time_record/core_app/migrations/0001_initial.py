...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dtl_act', models.CharField(blank=True, default='', max_length=225, null=True)),
                ('dtl_note', models.TextField(blank=True, default='', null=True)),
                ('act_act', models.ManyToManyField(to='core_app.act_record')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cal_morning', models.IntegerField(blank=True, default=0, null=True)),
                ('cal_noon', models.IntegerField(blank=True, default=0, null=True)),
                ('cal_night', models.IntegerField(blank=True, default=0, null=True)),
                ('cal_goal', models.IntegerField(blank=True, default=0, null=True)),
                ('cal_deficit', models.IntegerField(blank=True, default=0, null=True)),
